    ...
    <footer id="contacts" className="bg-[#1f1f1a] text-white">
      <div className="mx-auto max-w-[1600px] px-5 py-14 md:py-20">
        <div className="mb-14 border-b border-white/10 pb-10">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-[160px_1fr_auto] md:items-start">
            <div className="text-[32px] font-semibold uppercase tracking-[0.12em]">
              ист<span className="text-[#dadfc5]">Ø</span>к
            </div>

            <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-x-20">
            ...
            <a
              href="#top"
              className="inline-flex h-10 w-10 items-center justify-center border border-white/15 text-white/80 transition hover:border-white/30 hover:text-white"
              aria-label="Наверх"
            >
              ↑
            </a>
        ...
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-[280px_1fr] md:items-end">
          <div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-10">
            <div>
              <p className="mb-2 text-[14px] text-white/50">Офис продаж</p>
            ...
            <div>
              <p className="mb-2 text-[14px] text-white/50">Социальные сети</p>
              <div className="flex flex-wrap gap-4 text-[16px] text-white/80">
