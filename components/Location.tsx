        ...
        <div className="mt-[170px] grid grid-cols-1 gap-x-[66px] md:grid-cols-[394px_1fr]">
          ...
          <div className="grid grid-cols-1 gap-[18px] md:grid-cols-2">
            {destinations.map((item) => (
              <article
                key={item.title}
                className="group relative h-[330px] overflow-hidden border border-[#dedad3] bg-[#f7f5f1] p-[18px] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-[#bfbab1] hover:shadow-[0_16px_48px_rgba(0,0,0,0.08)]"
              >
                <div className="absolute inset-0 z-0 overflow-hidden">
                  <Image
                    ...
                    className="object-cover object-bottom-right opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]"
                    style={{
                      clipPath: "inset(calc(100% - 160px) 18px 18px calc(100% - 232px))",
                    }}
                  />
                ...
                <div className="absolute inset-0 z-[1] overflow-hidden">
                  <Image
                    ...
                    fill
                    sizes="(max-width: 768px) 100vw, 50vw"
                    className="object-cover opacity-0 scale-[1.02] transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-100 group-hover:opacity-100"
                  />
                </div>
